...
class Settings:
    ...
    FLYER_PATH: str = os.getenv("FLYER_PATH", "developers-bucket/smart-conference-app/flyers/")
    OUTLINE_PATH: str = os.getenv("OUTLINE_PATH", "developers-bucket/smart-conference-app/program_outlines/")
